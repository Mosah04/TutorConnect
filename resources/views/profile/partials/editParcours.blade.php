            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                            ...
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">IUT/LOKOSSA</th>
                            <td class="px-4 py-3">Licence Professionnelle</td>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">CSP "Les Palmiers"</th>
                            <td class="px-4 py-3">BAC D</td>
                            <td class="px-4 py-3">2020-2021</td>
                            <td class="px-4 py-3 flex items-center justify-end">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="px-6 py-6 lg:px-8">
              ...
              <form class="space-y-6" action="#">
                  ...
                  <div>
                    <label for="date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Année d'obtention</label>
